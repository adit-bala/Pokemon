...
public class NPC3 extends StaticEntity implements ActionListener {

	private boolean start;
	private Timer timer;
	private int counter;
	
	public NPC3(Handler handler, float x, float y) {
	...
	public void render(Graphics g) {
		...
		if(start) {
			...
			Text.drawString(g, "Howdy there!", 25, 350, false, Color.BLACK, Assets.font24);
			Text.drawString(g, "It seems there is", 25, 400, false, Color.BLACK, Assets.font24);
			Text.drawString(g, "some treasure close!", 25, 450, false, Color.BLACK, Assets.font24);
		}
	}
